...
import { Sort, TagsOrder } from '../../../interfaces';

interface Props {
  sort: Sort;
  order: TagsOrder;
  setSort: Dispatch<SetStateAction<Sort>>;
  setOrder: Dispatch<SetStateAction<TagsOrder>>;
}
...
const TagsSelect: FC<Props> = (props) => {
  ...
  const onChangeOrder = (e: SelectChangeEvent) => {
    setOrder(e.target.value as TagsOrder);
  };
    ...
    <>
      ...
      <FormControl sx={{ m: 1, minWidth: 120 }}>
        ...
        <Select value={order} label="Ordenar por" onChange={onChangeOrder}>
          ...
          <MenuItem value="first_name">Creado por</MenuItem>
        </Select>
      </FormControl>
    </>
  );
